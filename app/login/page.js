        ...
        <div className="w-screen gap-20 flex flex-col text-white items-center h-screen overflow-x-hidden">
            ...
            <div className='top-20 md:top-2 relative mx-auto text-center'>
                ...
                justify-center items-start gap-2 p-6 md:p-12 mx-auto  border-orange-300 border  rounded-xl'>
                    ...
                    <SearchBar />
                    <Link href={"/home"} className='bg-orange-300 text-black font-semibold rounded-2xl hover:border-orange-300 hover:border hover:bg-black hover:text-orange-300  text-xl mt-4 px-6 py-4'>Login</Link>
                    <a href="/signup" className='block text-sm text-orange-300 underline'>Already have an account? signup.</a>
                </form>
            </div>
        </div>
    )
